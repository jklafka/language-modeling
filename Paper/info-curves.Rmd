...
families_b %>%
  mutate(family = if_else(is.na(family), "other", family)) %>%
    filter(language %in% c("Russian", "Vietnamese", "Arabic", "Malay", "Slovenian", 
                           "Korean", "Croatian", "Bulgarian", "Finnish",
                           "Persian", "Bosnian", "Thai", "Sardinian",
                           "Sicilian", "Greek", "Javanese", "Urdu", "Icelandic",
                           "Tatar")) %>%
    distinct(language, position, .keep_all = T) %>%
