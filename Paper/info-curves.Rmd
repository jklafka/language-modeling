...
authornote: |
  Great thanks to Stephen Meylan and Adam King for comments. Thanks to the audiences of Midwest Cognitive Science conference 2019 and Cognitive Science Society conference 2019. Many thanks to the Communication and Learning Lab for comments and critiques. Funding from the JS McDonnell Foundation. 
...
```{r providence_unigrams, echo=F, fig.height =2, fig.cap="North American English frequency-based information curves. Lines around each point indicate 95% confidence intervals computed with non-parametric bootstrap"}
childes_results %>% 
