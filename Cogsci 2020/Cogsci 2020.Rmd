...
So far, we have only looked at the distribution of information in words in English, both with and without context. We've looked at conversational speech. 
...
In this paper we did model and it showed unique distributions for unigrams and diff distributions for trigrams. Developmental angle. 
