...
cat $3 | ~/kenlm/build/bin/lmplz -o 1 -S 10%  --discount_fallback > Models/$1/unigram/${2}/${5}.lm
...
~/kenlm/build/bin/build_binary Models/$1/trigram/${2}/${5}.arpa Models/$1/trigram/${2}/${5}.lm
